    ...
    init: function(t, i) {
        ...
        var e, s = {
            ...
            init: function(t) {
                ...
                this.canvas.getContext && (this.ctx = this.canvas.getContext("2d"), this.monster_type_count = s.getDefaultMonsterAttributes(), this.iframe = 0, this.last_iframe_time = (new Date).getTime(), this.fps = 0, this.start())
            },
            start: function() {
                clearTimeout(this._st),
                s.log("Start!");
                var t = this;
                return this._exp_fps_0 = this.exp_fps - .4,
            ...
            step: function() {
                if (this.is_debug && _TD && _TD.cheat && (this.checkCheat(_TD.cheat), _TD.cheat = ""), !this.is_paused) {
                    if (this.iframe++, this.iframe % 50 == 0) {
                        var t = (new Date).getTime(),
                        i = this.step_time;
                        this.fps = Math.round(5e5 / (t - this.last_iframe_time)) / 10,
                        this.last_iframe_time = t,
                        this.fps < this._exp_fps_0 && i > 1 ? i--:this.fps > this._exp_fps_1 && i++,
                        this.step_time = i
                    }
            ...
            gc: function() {
                window.CollectGarbage && (CollectGarbage(), setTimeout(CollectGarbage, 1))
            }
        };
...
_TD.a.push(function(t) {
    t.lang = {
        ...
        each: function(t, i) {
            ...
            s = t.length; s > e; e++) i(t[e])
        },
        any: function(t, i) {
            for (var e = 0,
            s = t.length; s > e; e++) if (i(t[e])) return t[e];
            return null
        },
        shift: function(t, i) {
            for (; t[0];) i(t.shift())
        ...
        rndStr: function(t) {
            ...
            n = [],
            h = s.length;
            for (i = 0; t > i; i++) e = Math.floor(Math.random() * h),
            n.push(s.substr(e, 1));
            return n.join("")
        },
        nullFunc: function() {},
...
_TD.a.push(function(t) {
    ...
    t.Stage.prototype = {
        _init: function() {
            ...
            "function" == typeof this.cfg.step2 && (this._step2 = this.cfg.step2)
        },
        start: function() {
            this.state = 1,
            t.lang.each(this.acts,
            function(t) {
                t.start()
            })
        },
...
_TD.a.push(function(t) {
    ...
    t.Act.prototype = {
        ...
        start: function() {
            return this.stage.current_act && 3 != this.stage.current_act.state ? (this.state = 0, void this.stage.current_act.queue(this.start)) : (this.state = 1, this.stage.current_act = this, void t.lang.each(this.scenes,
            function(t) {
                t.start()
            }))
        },
...
_TD.a.push(function(t) {
    ...
    t.Scene.prototype = {
        ...
        clear: function() {
            t.lang.shift(this._step_elements,
            function(i) {
                t.lang.shift(i,
                function(t) {
                    t.del()
            ...
            t.lang.shift(this._render_elements,
            function(i) {
                t.lang.shift(i,
                function(t) {
                    t.del()
...
_TD.a.push(function(t) {
    t.Element = function(i, e) {
        ...
        this.cfg = e || {},
        this.is_valid = !0,
        this.is_visiable = "undefined" != typeof e.is_visiable ? e.is_visiable: !0,
        this.is_paused = !1,
        this.is_hover = !1,
        this.x = this.cfg.x || -1,
        this.y = this.cfg.y || -1,
    ...
    t.Element.prototype = {
        ...
        addToScene: function(i, e, s, n) {
            this.scene = i,
            isNaN(e) || (this.step_level = e || this.step_level, this.render_level = s || this.render_level, n && t.lang.each(n,
            function(t) {
                i.addElement(t, e, s)
...
_TD.a.push(function(t) {
    ...
    s = {
        _init: function(s) {
            ...
            this.is_main_map && (this.mmm = new i(this.id + "-mmm", {
                map: this
            ...
            var c = this;
            s.grids_cfg && t.lang.each(s.grids_cfg,
            function(t) {
        ...
        preBuild: function(i) {
            ...
            this.pre_building = new t.Building(this.id + "-pre-building-" + t.lang.rndStr(), {
                type: i,
                map: this,
                is_pre_building: !0
            }),
        ...
        clearInvalidElements: function() {
            ...
            this._wait_clearInvalidElements = e;
            var i = [];
            t.lang.shift(this.buildings,
            function(t) {
                t.is_valid && i.push(t)
            }),
            this.buildings = i,
            i = [],
            t.lang.shift(this.monsters,
            function(t) {
                t.is_valid && i.push(t)
            }),
            this.monsters = i,
            i = [],
            t.lang.shift(this.bullets,
            function(t) {
                t.is_valid && i.push(t)
            }),
            this.bullets = i
        ...
        addMonsters: function(t, i) {
            this._wait_add_monsters = t,
            this._wait_add_monsters_objidx = i
        },
        ...
        step: function() {
            if (this.clearInvalidElements(), this._wait_add_monsters > 0) this.addMonster(this._wait_add_monsters_objidx),
        ...
        render: function() {
            ...
            i.beginPath(),
            i.strokeRect(this.x + .5, this.y + .5, this.width, this.height),
            i.closePath(),
            i.stroke()
        },
        onOut: function() {
...
_TD.a.push(function(t) {
    var i = {
        ...
        checkBlock: function() {
            if (this.is_entrance || this.is_exit) return this._block_msg = t._t("entrance_or_exit_be_blocked"),
            !0;
            var i, e = this,
            s = new t.FindWay(this.map.grid_x, this.map.grid_y, this.map.entrance.mx, this.map.entrance.my, this.map.exit.mx, this.map.exit.my,
            function(t, i) {
                return ! (t == e.mx && i == e.my) && e.map.checkPassable(t, i)
            });
            return i = s.is_blocked,
            i ? this._block_msg = t._t("blocked") : (i = !!this.map.anyMonster(function(t) {
        ...
        render: function() {
            ...
            e = this.x + .5,
            s = this.y + .5;
            this.is_hover && (i.fillStyle = "rgba(255, 255, 200, 0.2)", i.beginPath(), i.fillRect(e, s, this.width, this.height), i.closePath(), i.fill()),
            0 == this.passable_flag && (i.fillStyle = "#fcc", i.beginPath(), i.fillRect(e, s, this.width, this.height), i.closePath(), i.fill()),
            (this.is_entrance || this.is_exit) && (i.lineWidth = 1, i.fillStyle = "#ccc", i.beginPath(), i.fillRect(e, s, this.width, this.height), i.closePath(), i.fill(), i.strokeStyle = "#666", i.fillStyle = this.is_entrance ? "#fff": "#666", i.beginPath(), i.arc(this.cx, this.cy, .325 * t.grid_size, 0, 2 * Math.PI, !0), i.closePath(), i.fill(), i.stroke()),
            i.strokeStyle = "#eee",
            i.lineWidth = 1,
            i.beginPath(),
        ...
        onEnter: function() {
            if (this.map.is_main_map && "build" == t.mode) 1 == this.build_flag ? (this.map.pre_building.show(), this.map.pre_building.locate(this)) : this.map.pre_building.hide();
                ...
                var i = "";
                this.is_entrance ? i = t._t("entrance") : this.is_exit ? i = t._t("exit") : 0 == this.passable_flag ? i = t._t("_cant_pass") : 0 == this.build_flag && (i = t._t("_cant_build")),
...
_TD.a.push(function(t) {
    var i = {
        ...
        toggleSelected: function() {
            ...
            this.is_selected ? (this.map.eachBuilding(function(i) {
                ...
                t.is_selected = !1,
                t.grid.hightLight(!1)
            }), this.map.selected_building = this, this.map.is_main_map ? this.scene.map.cancelPreBuild() : this.scene.map.preBuild(this.type)) : (this.map.selected_building == this && (this.map.selected_building = null), this.map.is_main_map || this.scene.map.cancelPreBuild()),
            this.map.is_main_map && (this.map.selected_building ? (this.scene.panel.btn_upgrade.show(), this.scene.panel.btn_sell.show(), this.updateBtnDesc()) : (this.scene.panel.btn_upgrade.hide(), this.scene.panel.btn_sell.hide()))
        },
        updateBtnDesc: function() {
            this.scene.panel.btn_upgrade.desc = t._t("upgrade", [t._t("building_name_" + this.type), this.level + 1, this.getUpgradeCost()]),
            this.scene.panel.btn_sell.desc = t._t("sell", [t._t("building_name_" + this.type), this.getSellMoney()])
        },
        locate: function(i) {
            this.grid = i,
            this.map = i.map,
            ...
            this._fire_wait = Math.floor(Math.max(2 / (this.speed * t.global_speed), 1)),
            this._fire_wait2 = this._fire_wait
        },
        remove: function() {
            this.grid && this.grid.building && this.grid.building == this && (this.grid.building = null),
            this.hide(),
            this.del()
        },
        findTaget: function() {
            if (this.is_weapon && !this.is_pre_building && this.grid) {
                ...
                this.target && this.target.is_valid && Math.pow(this.target.cx - i, 2) + Math.pow(this.target.cy - e, 2) <= s || (this.target = t.lang.any(t.lang.rndSort(this.map.monsters),
                function(t) {
        ...
        tryToUpgrade: function(i) {
            ...
            s = "";
            e > t.money ? s = t._t("not_enough_money", [e]) : (t.money -= e, this.money += e, this.upgrade(), s = t._t("upgrade_success", [t._t("building_name_" + this.type), this.level, this.getUpgradeCost()])),
            this.updateBtnDesc(),
        ...
        render: function() {
            if (this.is_visiable && !(this.wait_blink < 0)) {
                ...
                this.map.is_main_map && (this.is_selected || this.is_pre_building || this.map.show_all_ranges) && this.is_weapon && this.range > 0 && this.grid && (i.lineWidth = _TD.retina, i.fillStyle = "rgba(187, 141, 32, 0.15)", i.strokeStyle = "#bb8d20", i.beginPath(), i.arc(this.cx, this.cy, this.range_px, 0, 2 * Math.PI, !0), i.closePath(), i.fill(), i.stroke()),
                "laser_gun" == this.type && this.target && this.target.is_valid && (i.lineWidth = 3 * _TD.retina, i.strokeStyle = "rgba(50, 50, 200, 0.5)", i.beginPath(), i.moveTo(this.cx, this.cy), i.lineTo(this.target.cx, this.target.cy), i.closePath(), i.stroke(), i.lineWidth = _TD.retina, i.strokeStyle = "rgba(150, 150, 255, 0.5)", i.beginPath(), i.lineTo(this.cx, this.cy), i.closePath(), i.stroke())
            }
        },
        onEnter: function() {
            if (!this.is_pre_building) {
                var i = "建筑工事";
                i = this.map.is_main_map ? t._t("building_info" + ("wall" == this.type ? "_wall": ""), [t._t("building_name_" + this.type), this.level, this.damage, this.speed, this.range, this.killed]) : t._t("building_intro_" + this.type, [t.getDefaultBuildingAttributes(this.type).cost]),
    ...
    var e = {
        ...
        checkOutOfMap: function() {
            return this.is_valid = !(this.cx < this.map.x || this.cx > this.map.x2 || this.cy < this.map.y || this.cy > this.map.y2),
            !this.is_valid
        },
        checkHit: function() {
            var i = this.cx,
...
_TD.a.push(function(t) {
    var i = {
        _init: function(i) {
            ...
            this.life = this.life0 = Math.floor(e.life * (this.difficulty + 1) * (Math.random() + .5) * .5),
            this.life < 1 && (this.life = this.life0 = 1),
            this.shield = Math.floor(e.shield + this.difficulty / 2),
            this.shield < 0 && (this.shield = 0),
            this.damage = Math.floor((e.damage || 1) * (.5 * Math.random() + .75)),
            this.damage < 1 && (this.damage = 1),
            this.money = e.money || Math.floor(Math.sqrt((this.speed + this.life) * (this.shield + 1) * this.damage)),
            ...
            this.r > t.grid_size / 2 - 4 * _TD.retina && (this.r = t.grid_size / 2 - 4 * _TD.retina),
        ...
        findWay: function() {
            var i = this,
            e = new t.FindWay(this.map.grid_x, this.map.grid_y, this.grid.mx, this.grid.my, this.map.exit.mx, this.map.exit.my,
            function(t, e) {
        ...
        getNextGrid: function() { (0 == this.way.length || Math.random() < .1) && this.findWay();
            var t = this.way.shift();
            t && !this.map.checkPassable(t[0], t[1]) && (this.findWay(), t = this.way.shift()),
            t && (this.next_grid = this.map.getGrid(t[0], t[1]))
        },
        chkIfBlocked: function(i, e) {
            var s = this,
            n = new t.FindWay(this.map.grid_x, this.map.grid_y, this.grid.mx, this.grid.my, this.map.exit.mx, this.map.exit.my,
            function(t, n) {
    ...
    var e = {
        ...
        render: function() {
            var i = t.ctx;
            i.fillStyle = "rgba(" + this.rgb_r + "," + this.rgb_g + "," + this.rgb_b + "," + this.rgb_a + ")",
            i.beginPath(),
            i.arc(this.cx, this.cy, this.r, 0, 2 * Math.PI, !0),
            i.closePath(),
            i.fill()
...
_TD.a.push(function(t) {
    var i = {
        ...
        step: function() {
            t.life_recover && (this._life_recover = this._life_recover2 = t.life_recover, this._life_recover_wait = this._life_recover_wait2 = 3 * t.exp_fps, t.life_recover = 0),
            this._life_recover && t.iframe % t.exp_fps_eighth == 0 && (t.life++, this._life_recover--)
        },
        render: function() {
            var i = t.ctx;
            if (i.textAlign = "left", i.textBaseline = "top", i.fillStyle = "#000", i.font = "normal " + 12 * _TD.retina + "px 'Courier New'", i.beginPath(), i.fillText(t._t("panel_money_title") + t.money, this.x, this.y), i.fillText(t._t("panel_score_title") + t.score, this.x, this.y + 20 * _TD.retina), i.fillText(t._t("panel_life_title") + t.life, this.x, this.y + 40 * _TD.retina), i.fillText(t._t("panel_building_title") + this.map.buildings.length, this.x, this.y + 60 * _TD.retina), i.fillText(t._t("panel_monster_title") + this.map.monsters.length, this.x, this.y + 80 * _TD.retina), i.fillText(t._t("wave_info", [this.scene.wave]), this.x, this.y + 210 * _TD.retina), i.closePath(), this._life_recover_wait) {
                ...
                i.beginPath(),
                i.fillText("+" + this._life_recover2, this.x + 60 * _TD.retina, this.y + 40 * _TD.retina),
                i.closePath(),
    ...
    var e = {
        ...
        caculatePos: function() {
            ...
            this.x = i.cx + .5,
            this.y = i.cy + .5,
            this.x + this.width > this.scene.stage.width - t.padding && (this.x = this.x - this.width),
        ...
        msg: function(i, e) {
            ...
            this.width = Math.max(s.measureText(i).width + 10 * _TD.retina, 6 * t.lang.strLen2(i) + 10 * _TD.retina),
...
_TD.a.push(function(t) {
    var i = function() {
        ...
        e.map = n,
        e.panel = new t.Panel("panel", t.lang.mix({
            scene: e,
            main_map: n,
            step_level: 1,
            render_level: 7
        ...
        var n = {
            ...
            scene_endless: {
                ...
                newWave: function(i) {
                    ...
                    s = i.wave || 1,
                    n = t.wave_damage || 0;
                    1 == s || (0 == n ? 5 > s ? t.difficulty *= 1.05 : t.difficulty > 30 ? t.difficulty *= 1.1 : t.difficulty *= 1.2 : t.wave_damage >= 50 ? t.difficulty *= .6 : t.wave_damage >= 30 ? t.difficulty *= .7 : t.wave_damage >= 20 ? t.difficulty *= .8 : t.wave_damage >= 10 ? t.difficulty *= .9 : s >= 10 && (t.difficulty *= 1.05)),
...
_TD.a.push(function(t) {
    function i(t, i, e, s, n, h) {
        ...
        a = s > i ? i + h: i - h;
            ...
            o = Math.sqrt(o),
            _ = ( - u + o) / (2 * d),
            s - i > 0 && _ - i > 0 || 0 > s - i && 0 > _ - i ? (a = _, l = r * a + c) : (a = ( - u - o) / (2 * d), l = r * a + c)
        }
    ...
    t.renderBuilding = function(i) {
        ...
        n = i.map,
        h = t.grid_size,
        a = t.grid_size / 2; (e[i.type] || e.wall)(i, s, n, h, a)
    }
}),
_TD.a.push(function(t) {
    t._msg_texts = {
        ...
        building_intro_cannon: "炮台 射程、伤害较为平衡 (￥${0})",
        building_intro_LMG: "轻机枪 射程较远，伤害一般 (￥${0})",
...
_TD.a.push(function(t) {
    t.FindWay = function(t, i, e, s, n, h, a) {
        ...
        this.fPassable = "function" == typeof a ? a: function() {
            return ! 0
        },
        this._init()
    },
    t.FindWay.prototype = {
        _init: function() {
            if (this.x1 == this.x2 && this.y1 == this.y2) return this.is_arrived = !0,
            void(this.way = [[this.x1, this.y1]]);
            for (var t = 0; t < this.len; t++) this.m[t] = -2;
            for (this.x = this.x1, this.y = this.y1, this.distance = 0, this.current = [[this.x, this.y]], this.setVal(this.x, this.y, 0); this.next(););
        },
        getVal: function(t, i) {
            var e = i * this.w + t;
        ...
        getAllNeighbors: function() {
            ...
            for (i = 0; n > i; i++) e = this.current[i],
            t = this.getNeighborsOf(e[0], e[1]),
            s = s.concat(t);
            return s
        },
        findWay: function() {
            for (var t, i, e, s, n, h, a, l = this.x2,
            r = this.y2,
            c = this.len,
            o = -1; (l != this.x1 || r != this.y1) && 0 != o && this.way.length < c;) {
                for (this.way.unshift([l, r]), e = this.getNeighborsOf(l, r), i = e.length, a = [], o = -1, s = 0; i > s; s++) h = this.getVal(e[s][0], e[s][1]),
                0 > h || (0 > o || o > h) && (o = h);
                for (s = 0; i > s; s++) t = e[s],
                o == this.getVal(t[0], t[1]) && a.push(t);
                n = a.length,
        ...
        next: function() {
            ...
            a = h.length,
            l = [];
            for (this.distance++, s = 0; a > s; s++) if (t = h[s], i = t[0], e = t[1], -2 == this.getVal(i, e) && (this.fPassable(i, e) ? (n = this.distance, l.push(t)) : n = -1, this.setVal(i, e, n), i == this.x2 && e == this.y2)) return this.arrive(),
            !1;
